...
$_['text_faq']                             = '<details><summary>Le montant des frais est-il entré avec ou sans taxe ?</summary>Le montant des frais doit être saisi avec la taxe incluse. L\'extension recalculera automatiquement le montant net en fonction des paramètres fiscaux du magasin ; par exemple, des frais de 5 EUR avec un taux de taxe de 20 % seront ajustés à 4,17 EUR (nets) lors du paiement.</details><details><summary>Puis-je appliquer des frais différents pour d\'autres méthodes de paiement ?</summary>Non, cette extension ne s\'applique qu\'aux commandes utilisant la méthode de paiement par virement bancaire.</details><details><summary>Les frais seront-ils affichés séparément dans le récapitulatif de la commande ?</summary>Oui, les frais seront affichés comme un élément distinct dans le récapitulatif de la commande lors du paiement, avec les ajustements fiscaux effectués selon les paramètres fiscaux du magasin.</details>';
