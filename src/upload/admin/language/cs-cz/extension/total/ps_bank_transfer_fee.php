...
$_['text_getting_started']                 = '<p><strong>Přehled:</strong> Rozšíření Playful Sparkle - Poplatek za bankovní převod pro OpenCart 3 umožňuje majitelům obchodů přidat konfigurovatelný poplatek k objednávkám s platební metodou Bankovní převod. Tato funkce pomáhá kompenzovat poplatky za zpracování bankovních převodů a poskytuje větší kontrolu nad celkovou částkou objednávky.</p><p><strong>Požadavky:</strong> OpenCart 3.0+, PHP 7.2 nebo vyšší a platební metoda Bankovní převod povolená v nastavení obchodu.</p>';
