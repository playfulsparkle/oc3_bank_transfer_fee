...
$_['text_getting_started']                 = '<p><strong>Prehľad:</strong> Rozšírenie Playful Sparkle - Poplatok za bankový prevod pre OpenCart 3 umožňuje vlastníkom obchodov pridať konfigurovateľný poplatok k objednávkam využívajúcim metódu platby bankovým prevodom. Táto funkcia pomáha vyrovnať náklady na spracovanie bankových prevodov a poskytuje väčšiu kontrolu nad celkovými nákladmi na objednávky.</p><p><strong>Požiadavky:</strong> OpenCart 3.0+, PHP 7.2 alebo vyšší, a metóda platby bankovým prevodom musí byť povolená v nastaveniach obchodu.</p>';
...
$_['text_contact']                         = '<p>Pre ďalšiu pomoc, prosím, kontaktujte náš tím podpory:</p><ul><li><strong>Kontakt:</strong> <a href="mailto:%s">%s</a></li><li><strong>Dokumentácia:</strong> <a href="https://github.com/playfulsparkle/oc4_google_tag_manager" target="_blank" rel="noopener noreferrer">Dokumentácia pre používateľov</a></li></ul>';
