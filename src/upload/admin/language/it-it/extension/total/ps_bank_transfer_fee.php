...
$_['text_faq']                             = '<details><summary>Posso applicare commissioni differenti per altri metodi di pagamento?</summary>No, questa estensione si applica solo agli ordini che utilizzano il metodo di pagamento tramite bonifico bancario.</details><details><summary>La commissione apparirà separatamente nel riepilogo dell’ordine?</summary>Sì, la commissione apparirà come voce separata nel riepilogo dell’ordine durante il checkout, con adeguamenti fiscali effettuati in base alle impostazioni fiscali del negozio.</details>';
