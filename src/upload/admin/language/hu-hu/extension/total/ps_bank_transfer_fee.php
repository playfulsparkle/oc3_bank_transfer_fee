...
$_['text_getting_started']                 = '<p><strong>Áttekintés:</strong> A Playful Sparkle - Banki Átutalási Díj kiterjesztés az OpenCart 3.x-hoz lehetőséget biztosít az áruház tulajdonosainak, hogy testreszabható díjat adjanak az olyan rendelésekhez, ahol a banki átutalás fizetési mód van kiválasztva. Ez a funkció segít ellensúlyozni az átutalások feldolgozási költségeit, és nagyobb kontrollt biztosít a végösszeg felett.</p><p><strong>Követelmények:</strong> OpenCart 3.x+, PHP 7.2 vagy újabb verzió, valamint a banki átutalás fizetési mód engedélyezése az áruház beállításaiban.</p>';
